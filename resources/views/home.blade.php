...
<div class="container-fluid" style="background-image: url({{ asset('/images/hero_2.jpg') }}); background-repeat:no-repeat; background-size:cover;">
	<div class="row">
		<div class="col-md-6">
			<div id="homepage-box">
				<h1 style="margin-top:15px; padding:10px 15px; font-size:30px;">HELP ROCKFORD SALUTE ITS VETERANS!</h1>
				...
				<p style="font-size:20px; padding:0px 10px;">Saturday, October 10 <br>
					BMO Harris Bank Center <br>
					Rockford, IL  <br>
				</p>
				<p style="font-size:14px; padding:5px 10px;">
